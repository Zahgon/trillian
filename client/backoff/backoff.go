...
func RetriableErrorf(format string, a ...interface{}) error { _ = "STUB: not implemented"; return nil }
...
func (b *Backoff) Duration() time.Duration { _ = "STUB: not implemented"; return *new(time.Duration) }
...
func IsRetryable(err error, retry ...codes.Code) bool { _ = "STUB: not implemented"; return false }
...
// Client can just retry the call.
// Client can retry the read-modify-write function.
